...
<body>
    ...
    <div class="main-content">
        <div class="relative-box">
            ...
            <!-- BMW 3 -->
            <div class="showcaseImage group" data-tooltip="Click to view more on BMW 3 Series">
            ...
            <!-- BMW 5 -->
            <div class="showcaseImage group" data-tooltip="Click to view more on BMW 5 Series">
            ...
            <!-- BMW 7 -->
            <div class="showcaseImage group" data-tooltip="Click to view more on BMW i7">
                <img src="../assets/bmwi7.jfif " alt="BMW" class="w-full h-auto">
                <span class="showcase-text-7">BMW i7</span>
            ...
            <!-- BMW 4 -->
            <div class="showcaseImage group" data-tooltip="Click to view more on BMW 4 Series">
            ...
            <!-- BMW 8 -->
            <div class="showcaseImage group" data-tooltip="Click to view more on BMW 8 Series">
