<footer>
    <div class="footer-container">
        <span class="footer-title">BAVARIA</span>
        <div class="copyright-rows">
            <span class="copyrights-text">All rights reserved</span>
            <svg class="text-[#f2f2f2] size-5" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span class="copyrights-text">2026 by SeraphicX</span>
        </div>
    </div>
</footer>